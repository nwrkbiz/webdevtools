  ...
  { win_main = new Fl_Double_Window(490, 520, "Web Tools");
    ...
    { Fl_Tabs* o = new Fl_Tabs(0, 0, 490, 520);
      { Fl_Group* o = new Fl_Group(0, 25, 490, 495, "HTTPServer");
        { ti_http_addr = new Fl_Input(135, 40, 165, 30, "Bind Address:");
        } // Fl_Input* ti_http_addr
        { vi_http_port = new Fl_Value_Input(345, 40, 90, 30, "Port:");
        } // Fl_Value_Input* vi_http_port
        { ti_http_folder = new Fl_File_Input(135, 80, 240, 35, "Root directory:");
        } // Fl_File_Input* ti_http_folder
        { btn_http_folder = new Fl_Button(375, 80, 60, 35, "Select");
        } // Fl_Button* btn_http_folder
        { vi_http_threads = new Fl_Value_Input(135, 130, 90, 30, "Threads:");
        } // Fl_Value_Input* vi_http_threads
        { chb_http_ssl = new Fl_Check_Button(360, 130, 25, 25, "Use SSL");
          chb_http_ssl->down_box(FL_DOWN_BOX);
        } // Fl_Check_Button* chb_http_ssl
        { ti_http_certificate = new Fl_File_Input(135, 170, 240, 35, "Certificate:");
          ti_http_certificate->deactivate();
        } // Fl_File_Input* ti_http_certificate
        { btn_http_certificate = new Fl_Button(375, 170, 60, 35, "Select");
          btn_http_certificate->deactivate();
        } // Fl_Button* btn_http_certificate
        { ti_http_certkey = new Fl_File_Input(135, 220, 240, 35, "Key:");
          ti_http_certkey->deactivate();
          Fl_Group::current()->resizable(ti_http_certkey);
        } // Fl_File_Input* ti_http_certkey
        { btn_http_certkey = new Fl_Button(375, 220, 60, 35, "Select");
          btn_http_certkey->deactivate();
        } // Fl_Button* btn_http_certkey
        { btn_http_start = new Fl_Return_Button(155, 265, 180, 30, "Start");
        } // Fl_Return_Button* btn_http_start
        { te_http_rcv = new Fl_Text_Editor(40, 330, 410, 175, "Request Received:");
          te_http_rcv->deactivate();
